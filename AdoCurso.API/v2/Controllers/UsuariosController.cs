...
using AdoCurso.API.Models.Interfaces.v2;
using AdoCurso.API.Repositories.v2;
using Microsoft.AspNetCore.Mvc;
using System;

namespace AdoCurso.API.v2.Controllers
{
    [ApiController]
    [ApiVersion("2.0")]
    ...
    {
        #region Propriedades
        private readonly IUsuarioRepositoryV2 _repository;
        #endregion

        #region Construtor
        public UsuariosController()
        {
            _repository = new UsuarioRepositoryV2();
        }
        #endregion
